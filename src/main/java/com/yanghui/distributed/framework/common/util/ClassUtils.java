...
import static com.yanghui.distributed.framework.common.util.ClassLoaderUtils.getCurrentClassLoader;
...
public final class ClassUtils {
     ...
     */
    public static <T> T newInstance(Class<T> clazz) throws RpcRuntimeException {
