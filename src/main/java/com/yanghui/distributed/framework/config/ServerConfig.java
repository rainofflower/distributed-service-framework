...
import com.yanghui.distributed.framework.core.exception.RpcRuntimeException;
import com.yanghui.distributed.framework.common.util.NetUtils;
import com.yanghui.distributed.framework.server.Server;
import com.yanghui.distributed.framework.server.ServerFactory;

import java.io.Serializable;
import java.util.Map;
import java.util.concurrent.ConcurrentHashMap;

import static com.yanghui.distributed.framework.common.RpcConfigs.*;
import static com.yanghui.distributed.framework.common.RpcConstants.DISPATCHER_MESSAGE;
import static com.yanghui.distributed.framework.common.RpcOptions.*;
import static com.yanghui.distributed.framework.common.util.StringUtils.CONTEXT_SEP;
...
public class ServerConfig implements Serializable {
     ...
     */
    @Deprecated
    protected String                          dispatcher       = DISPATCHER_MESSAGE;
    ...
    protected int                              idleTime        =getIntValue(SERVER_IDLE_TIME);
    ...
    public ServerConfig setPort(int port) {
        if (!NetUtils.isRandomPort(port) && NetUtils.isInvalidPort(port)) {
            throw new RpcRuntimeException("server.port "+port + ""+
    ...
    public ServerConfig setContextPath(String contextPath) {
        if (!contextPath.endsWith(CONTEXT_SEP)) {
            contextPath += CONTEXT_SEP;
        }
